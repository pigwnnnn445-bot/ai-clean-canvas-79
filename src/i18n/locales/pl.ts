...
const pl: Translations = {
  meta: { title: "Seedance 2.0 Generator Wideo AI | Multimodalne Tworzenie i Rozszerzanie Wideo", description: "Generuj filmy AI za pomocą Seedance 2.0 z użyciem tekstu, obrazów, wideo i audio. Idealne do spójności postaci, referencji ruchu, rozszerzania wideo i edycji w języku naturalnym." },
