...
const pl: Translations = {
  ...
  hero: { title: "Seedance", subtitle: "Doświadcz", subtitleHighlight: "prawdziwego multimodalnego tworzenia wideo AI", imageToVideo: "Obraz do Wideo", textToVideo: "Tekst do Wideo", aiModel: "Model AI", images: "Obrazy", addEndFrame: "Dodaj końcową klatkę", uploadFirstFrame: "Prześlij Pierwszą Klatkę", uploadLastFrame: "Prześlij Ostatnią Klatkę", clickToUpload: "Kliknij aby przesłać lub przeciągnij i upuść", supportedFormats: "PNG, JPG, JPEG, WEBP", prompt: "Prompt", promptPlaceholder: "Opisz jak chcesz animować swój obraz...", resolution: "Rozdzielczość", duration: "Czas trwania", aspectRatio: "Proporcje", generate: "Generuj", generating: "Generowanie...", cost: "Koszt", credits: "kredytów", available: "Dostępne", downloadVideo: "Pobierz Wideo", downloadSuccess: "Wideo pobrane pomyślnie", viewHistory: "Zobacz Historię" },
