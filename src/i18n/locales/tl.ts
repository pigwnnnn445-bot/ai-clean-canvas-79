...
const tl: Translations = {
  ...
  hero: { title: "Seedance", subtitle: "Maranasan ang", subtitleHighlight: "tunay na multi-modal AI video creation", subtitleDesc: "Pagsamahin ang mga larawan, video, audio, at teksto upang bumuo ng cinematic na nilalaman na may tumpak na kakayahan sa sanggunian, walang putol na pagpapalawak ng video, at kontrol sa natural na wika.", imageToVideo: "Larawan sa Video", textToVideo: "Teksto sa Video", aiModel: "AI Model", images: "Mga Larawan", addEndFrame: "Magdagdag ng huling frame", uploadFirstFrame: "I-upload ang Unang Frame", uploadLastFrame: "I-upload ang Huling Frame", clickToUpload: "I-click para mag-upload o i-drag at i-drop", supportedFormats: "PNG, JPG, JPEG, WEBP", prompt: "Prompt", promptPlaceholder: "Ilarawan kung paano mo gustong i-animate ang iyong larawan...", resolution: "Resolution", duration: "Tagal", aspectRatio: "Aspect Ratio", generate: "Gumawa", generating: "Gumagawa...", cost: "Gastos", credits: "credits", available: "Magagamit", downloadVideo: "I-download ang Video", downloadSuccess: "Matagumpay na na-download ang video", viewHistory: "Tingnan ang Kasaysayan", modelDesc20: "Mas matatag na mga paksa, mas makinis na paglipat, at mga resulta na mas malapit sa handa nang gamitin na video.", modelDesc15: "Ang galaw sa footage ay natural at maayos, ang texture ay delikado at makatotohanan, at ang pangkalahatang estilo ay pare-pareho at lubos na pinakintab." },
