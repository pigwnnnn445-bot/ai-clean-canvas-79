...
const tl: Translations = {
  meta: { title: "Seedance 2.0 AI Video Generator | Multimodal na Paggawa at Extension ng Video", description: "Gumawa ng AI video gamit ang Seedance 2.0 na may text, imahe, video, at audio input. Ideal para sa character consistency, motion reference, video extension, at natural language editing." },
