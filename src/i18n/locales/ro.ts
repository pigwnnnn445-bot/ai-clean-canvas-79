...
const ro: Translations = {
  ...
  features: { title: "Funcții Cheie Seedance", titleHighlight: "2.0", subtitle: "Un model video AI multimodal cu adevărat controlabil.", items: [
    { title: "Input Multimodal", description: "Încarcă până la 9 imagini, 3 videouri și 3 fișiere audio." },
    { title: "Referință la Orice", description: "Referință la mișcare, efecte, mișcări de cameră și personaje cu limbaj natural." },
    { title: "Consistență Superioară", description: "Menține consistența perfectă pentru fețe, îmbrăcăminte, text și stiluri vizuale." },
    { title: "Replicare Precisă a Mișcării", description: "Încarcă un video de referință pentru a replica coregrafii complexe." },
  ...
  howItWorks: { title: "Cum Creezi Video AI", cta: "Începe să Creezi", steps: [
    { title: "Încarcă Resursele", description: "Încarcă imagini, videouri sau fișiere audio ca referințe." },
  ...
  pricing: { title: "Prețuri", subtitle: "Alege planul potrivit.", monthly: "Lunar", annually: "Anual", save: "Economisește 50%", perMonth: "/lună", subscribe: "Abonează-te", mostPopular: "Cel Mai Popular", plans: [
    ...
    { name: "Pro", desc: "Ideal pentru utilizatori avansați", credits: "6.000 credite/lună", features: ["Până la 600 videouri/lună", "Mai multe modele AI", "Cea mai rapidă generare", "Fără filigran", "Suport expert", "Licență comercială"] },
  ]},
  faq: { title: "Întrebări Frecvente", contactText: "Ai întrebări? Contactează", items: [
    ...
    { q: "Ce inputuri suportă?", a: "Patru modalități: imagini, videouri, audio și text." },
    { q: "Cum funcționează extensia video?", a: "Încarcă video și specifică secundele de adăugat." },
    { q: "Pot edita videouri existente?", a: "Da! Înlocuiește personaje, modifică acțiuni, adaugă sau elimină elemente." },
    { q: "Ce durate și rezoluții sunt suportate?", a: "Videouri de 4-15 secunde cu rezoluții până la 1080p." },
    { q: "Sunt filigrane pe videouri?", a: "Nu! Toate videourile sunt fără filigran." },
    { q: "Cum încep?", a: "Creează un cont, alege un plan și începe." },
  ]},
  footer: { title: "Gata să Creezi?", subtitle: "Alătură-te miilor de creatori care folosesc Seedance 2.0.", cta: "Începe să Creezi", multiModal: "Input multimodal", watermarkFree: "Fără filigran", referenceAny: "Referință la orice" },
};
export default ro;
