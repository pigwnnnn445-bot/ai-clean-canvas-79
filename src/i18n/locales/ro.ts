...
const ro: Translations = {
  meta: { title: "Seedance 2.0 Generator Video AI | Creare și Extindere Video Multimodală", description: "Generați videoclipuri AI cu Seedance 2.0 folosind text, imagini, video și audio. Ideal pentru consistența personajelor, referința mișcării, extinderea video și editarea în limbaj natural." },
