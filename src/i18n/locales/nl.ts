...
const nl: Translations = {
  meta: { title: "Seedance 2.0 AI-Videogenerator | Multimodale Videocreatie & Extensie", description: "Genereer AI-video's met Seedance 2.0 met tekst-, beeld-, video- en audio-invoer. Ideaal voor karakterconsistentie, bewegingsreferentie, video-extensie en natuurlijke taalbewerking." },
