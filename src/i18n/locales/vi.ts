...
const vi: Translations = {
  ...
  hero: { title: "Seedance", subtitle: "Trải nghiệm", subtitleHighlight: "tạo video AI đa phương thức thực sự", imageToVideo: "Ảnh sang Video", textToVideo: "Văn bản sang Video", aiModel: "Mô hình AI", images: "Hình ảnh", addEndFrame: "Thêm khung cuối", uploadFirstFrame: "Tải lên Khung Đầu", uploadLastFrame: "Tải lên Khung Cuối", clickToUpload: "Nhấp để tải lên hoặc kéo và thả", supportedFormats: "PNG, JPG, JPEG, WEBP", prompt: "Prompt", promptPlaceholder: "Mô tả cách bạn muốn tạo hoạt ảnh cho hình ảnh...", resolution: "Độ phân giải", duration: "Thời lượng", aspectRatio: "Tỷ lệ khung hình", generate: "Tạo", generating: "Đang tạo...", cost: "Chi phí", credits: "credits", available: "Có sẵn", downloadVideo: "Tải xuống Video", downloadSuccess: "Tải video thành công", viewHistory: "Xem lịch sử" },
