...
const hu: Translations = {
  meta: { title: "Seedance 2.0 AI Videógenerátor | Multimodális Videókészítés és Bővítés", description: "Készítsen AI videókat a Seedance 2.0-val szöveg, kép, videó és hang bemenetekkel. Ideális a karakterkonzisztenciához, mozgásreferenciához, videóbővítéshez és természetes nyelvi szerkesztéshez." },
