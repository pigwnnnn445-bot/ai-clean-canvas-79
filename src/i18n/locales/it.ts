...
const it: Translations = {
  meta: { title: "Seedance 2.0 Generatore Video AI | Creazione ed Estensione Video Multimodale", description: "Genera video AI con Seedance 2.0 usando input di testo, immagini, video e audio. Ideale per coerenza dei personaggi, riferimento del movimento, estensione video e editing in linguaggio naturale." },
