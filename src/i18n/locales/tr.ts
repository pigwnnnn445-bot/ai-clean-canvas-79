...
const tr: Translations = {
  meta: { title: "Seedance 2.0 AI Video Oluşturucu | Çok Modlu Video Oluşturma ve Uzatma", description: "Seedance 2.0 ile metin, görüntü, video ve ses girdileri kullanarak AI videoları oluşturun. Karakter tutarlılığı, hareket referansı, video uzatma ve doğal dil düzenleme için idealdir." },
